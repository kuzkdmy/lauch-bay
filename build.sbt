...
ThisBuild / organization := "com.demandbase.lauch_bay"
...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.softwaremill.sttp.tapir"   %% "tapir-prometheus-metrics"      % "0.19.0-M12",
      "com.softwaremill.sttp.tapir"   %% "tapir-swagger-ui-zio-http"     % "0.19.0-M4", // why they don't publish all, not clear
      "com.softwaremill.sttp.tapir"   %% "tapir-zio-http"                % "0.19.0-M12",
      "dev.zio"                       %% "zio"                           % "1.0.12",
